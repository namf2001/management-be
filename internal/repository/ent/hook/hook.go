...
// The PlayerStatisticFunc type is an adapter to allow the use of ordinary
// function as PlayerStatistic mutator.
type PlayerStatisticFunc func(context.Context, *ent.PlayerStatisticMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f PlayerStatisticFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.PlayerStatisticMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.PlayerStatisticMutation", m)
}
...
// The TeamFeeFunc type is an adapter to allow the use of ordinary
// function as TeamFee mutator.
type TeamFeeFunc func(context.Context, *ent.TeamFeeMutation) (ent.Value, error)

// Mutate calls f(ctx, m).
func (f TeamFeeFunc) Mutate(ctx context.Context, m ent.Mutation) (ent.Value, error) {
	if mv, ok := m.(*ent.TeamFeeMutation); ok {
		return f(ctx, mv)
	}
	return nil, fmt.Errorf("unexpected mutation type %T. expect *ent.TeamFeeMutation", m)
}
