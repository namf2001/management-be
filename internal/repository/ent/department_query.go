...
func (dq *DepartmentQuery) QueryPlayers() *PlayerQuery {
...
func (dq *DepartmentQuery) FirstID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (dq *DepartmentQuery) FirstIDX(ctx context.Context) int32 {
...
func (dq *DepartmentQuery) OnlyID(ctx context.Context) (id int32, err error) {
	var ids []int32
...
func (dq *DepartmentQuery) OnlyIDX(ctx context.Context) int32 {
...
func (dq *DepartmentQuery) IDs(ctx context.Context) (ids []int32, err error) {
...
func (dq *DepartmentQuery) IDsX(ctx context.Context) []int32 {
	ids, err := dq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (dq *DepartmentQuery) Clone() *DepartmentQuery {
	...
	return &DepartmentQuery{
		...
		withPlayers: dq.withPlayers.Clone(),
...
func (dq *DepartmentQuery) WithPlayers(opts ...func(*PlayerQuery)) *DepartmentQuery {
	query := (&PlayerClient{config: dq.config}).Query()
	for _, opt := range opts {
		opt(query)
	}
	dq.withPlayers = query
	return dq
}
...
func (dq *DepartmentQuery) sqlAll(ctx context.Context, hooks ...queryHook) ([]*Department, error) {
	...
	if query := dq.withPlayers; query != nil {
		if err := dq.loadPlayers(ctx, query, nodes,
			func(n *Department) { n.Edges.Players = []*Player{} },
			func(n *Department, e *Player) { n.Edges.Players = append(n.Edges.Players, e) }); err != nil {
			return nil, err
		}
	}
	return nodes, nil
...
func (dq *DepartmentQuery) loadPlayers(ctx context.Context, query *PlayerQuery, nodes []*Department, init func(*Department), assign func(*Department, *Player)) error {
	fks := make([]driver.Value, 0, len(nodes))
	nodeids := make(map[int32]*Department)
	for i := range nodes {
	...
	if len(query.ctx.Fields) > 0 {
		query.ctx.AppendFieldOnce(player.FieldDepartmentID)
	}
	query.Where(predicate.Player(func(s *sql.Selector) {
		s.Where(sql.InValues(s.C(department.PlayersColumn), fks...))
	}))
...
func (dq *DepartmentQuery) querySpec() *sqlgraph.QuerySpec {
	_spec := sqlgraph.NewQuerySpec(department.Table, department.Columns, sqlgraph.NewFieldSpec(department.FieldID, field.TypeInt32))
	_spec.From = dq.sql
