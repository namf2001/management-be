...
func (e DepartmentEdges) PlayersOrErr() ([]*Player, error) {
	if e.loadedTypes[0] {
...
// QueryPlayers queries the "players" edge of the Department entity.
func (d *Department) QueryPlayers() *PlayerQuery {
	return NewDepartmentClient(d.config).QueryPlayers(d)
}
