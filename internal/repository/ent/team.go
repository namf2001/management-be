...
func (e TeamEdges) MatchesOrErr() ([]*Match, error) {
	if e.loadedTypes[0] {
...
func (*Team) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case team.FieldName, team.FieldCompanyName, team.FieldContactPerson, team.FieldContactPhone, team.FieldContactEmail:
...
// QueryMatches queries the "matches" edge of the Team entity.
func (t *Team) QueryMatches() *MatchQuery {
	return NewTeamClient(t.config).QueryMatches(t)
}
...
func (t *Team) String() string {
	...
	builder.WriteString(t.CompanyName)
	builder.WriteString(", ")
	builder.WriteString("contact_person=")
	builder.WriteString(t.ContactPerson)
	builder.WriteString(", ")
