...
import (
	...
	"management-be/internal/repository/football_match"
...
type Registry interface {
	...
	FootballMatch() football_match.Repository
...
func NewRegistry(entConn *ent.Client) Registry {
	return &impl{
		...
		footballMatch:    football_match.NewRepository(entConn),
	}
}
...
func (i *impl) FootballMatch() football_match.Repository {
	return i.footballMatch
}
